...
function welcomeUser() {
    var a = 0,
        ...
        c = setInterval(function() {
            0 === a && (setBoxText(1), showBoxTime(7, .05));
            a === b && (setBoxText(2), showBoxTime(4, 1));
            a === b + 7 && (setBoxText(3), promoCount = catchText3, showBoxTime(10, .01), clearInterval(c), customLead(genRandNum(7, 20)));
            a++
        }, 1E3)}
function customLead(a) {
    setTimeout(function() {
        var a = 0,
            c = setInterval(function() {
                0 === a && (setBoxText(2), showBoxTime(6, 1));
                7 === a && (promoCount--, 0 < promoCount ? document.getElementById("popWindow").innerHTML = "Có <i>" + promoCount + "</i> người đang xem dịch vụ" : document.getElementById("popWindow").innerHTML = "<p>Thiết Kế logo , panel , bìa ,... </p>",
                    showBoxTime(10, .01));
